    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          We are currently performing important updates to improve your experience. 
          Our system is monitoring the status and will automatically reload this page 
        ...
        <div style={{
          ...
          <span style={{ fontSize: '15px' }}>Monitoring systems...</span>
        </div>
