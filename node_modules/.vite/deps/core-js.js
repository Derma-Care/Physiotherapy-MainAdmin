  ...
  "node_modules/core-js/internals/array-buffer.js"(exports, module) {
    ...
    if (!NATIVE_ARRAY_BUFFER) {
      ...
      $DataView = function DataView2(buffer, byteOffset, byteLength) {
        ...
        byteLength = byteLength === void 0 ? bufferLength - offset : toIndex(byteLength);
...
var require_iterator_helper_without_closing_on_early_error = __commonJS({
  "node_modules/core-js/internals/iterator-helper-without-closing-on-early-error.js"(exports, module) {
    ...
    module.exports = function(METHOD_NAME, ExpectedError) {
      var Iterator2 = globalThis.Iterator;
      ...
      return defineBuiltIns(create(AsyncIteratorPrototype), {
        ...
        "return": function() {
          ...
          var closeOuterIterator = function() {
            var completion2 = perform(function() {
              return getMethod(iterator, "return");
            });
            returnMethod = result = completion2.value;
            if (completion2.error) return Promise2.reject(result);
            if (returnMethod === void 0) return Promise2.resolve(createIterResultObject(void 0, true));
            completion2 = perform(function() {
              return call(returnMethod, iterator);
            });
            result = completion2.value;
            if (completion2.error) return Promise2.reject(result);
          ...
          if (inner) {
            ...
            if (innerReturn) {
              return Promise2.resolve(completion.value).then(function(innerResult) {
                try {
    ...
    var AsyncIteratorProxy = createAsyncIteratorProxy(function(Promise2) {
      ...
      if (!state.remaining--) {
        ...
        if (returnMethod !== void 0) {
          return Promise2.resolve(call(returnMethod, iterator)).then(function(result) {
            anObject(result);
            return resultDone;
          });
        }
  ...
  "node_modules/core-js/modules/esnext.number.from-string.js"() {
    ...
    var validDigitForRadix = function(string, R) {
      for (var i = 0; i < string.length; i++) {
        ...
        if (code === 46) continue;
        if (code >= 48 && code <= 57) {
          if (code - 48 >= R) return false;
        } else if (code >= 97 && code <= 122) {
          if (code - 97 + 10 >= R) return false;
        } else return false;
      }
      return true;
    };
